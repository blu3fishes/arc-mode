data modify storage twohand modified insert 0 from entity @s Inventory[{Slot:4b}]
data modify storage twohand modified[{Slot:4b}].Slot set value 0b
...
loot replace entity @s hotbar.4 1 mine 0 0 16
