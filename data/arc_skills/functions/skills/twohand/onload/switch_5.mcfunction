data modify storage twohand modified insert 0 from entity @s Inventory[{Slot:5b}]
data modify storage twohand modified[{Slot:5b}].Slot set value 0b
...
loot replace entity @s hotbar.5 1 mine 0 0 16
