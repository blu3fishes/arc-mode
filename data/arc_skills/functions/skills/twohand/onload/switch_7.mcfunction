data modify storage twohand modified insert 0 from entity @s Inventory[{Slot:7b}]
data modify storage twohand modified[{Slot:7b}].Slot set value 0b
...
loot replace entity @s hotbar.7 1 mine 0 0 16
