data modify storage twohand modified insert 0 from entity @s Inventory[{Slot:8b}]
data modify storage twohand modified[{Slot:8b}].Slot set value 0b
...
loot replace entity @s hotbar.8 1 mine 0 0 16
