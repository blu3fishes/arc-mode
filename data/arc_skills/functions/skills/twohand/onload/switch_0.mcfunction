data modify storage twohand modified insert 0 from entity @s Inventory[{Slot:0b}]
data modify storage twohand modified[{Slot:0b}].Slot set value 0b
...
loot replace entity @s hotbar.0 1 mine 0 0 16
