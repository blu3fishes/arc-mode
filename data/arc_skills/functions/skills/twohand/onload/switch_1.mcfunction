data modify storage twohand modified insert 0 from entity @s Inventory[{Slot:1b}]
data modify storage twohand modified[{Slot:1b}].Slot set value 0b
data modify storage twohand modified[{Slot:0b}].tag.Enchantments[{id:"minecraft:sweeping"}].lvl set value 9s
# data modify storage twohand modified[{Slot:1b}].tag.twohand set value 0b
setblock 0 0 16 shulker_box
data modify block 0 0 16 Items set from storage twohand modified
loot replace entity @s hotbar.1 1 mine 0 0 16
