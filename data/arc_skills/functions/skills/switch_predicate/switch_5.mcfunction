data modify storage switch toOffhand insert 0 from entity @s Inventory[{Slot:5b}]
data modify storage switch toOffhand[{Slot:5b}].Slot set value 0b
setblock 0 0 0 shulker_box
data modify block 0 0 0 Items set from storage switch toMainhand
loot replace entity @s hotbar.5 1 mine 0 0 0
setblock 0 0 0 shulker_box
