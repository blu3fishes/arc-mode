...
btn = ttk.Button(mainWindow, text="제작하기", command= lambda : createMain(NameSpaceBufTxt.get(), SpaceBufTxt.get(), NameBufTxt.get(), CmdBufTxt.get(), funcSpaceBuf.get()), width=20)
