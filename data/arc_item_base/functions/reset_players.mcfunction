...
recipe take @s arc_item_base:platinum/platinum_hoe
...
recipe take @s arc_item_base:platinum/platinum_shovel
...
advancement revoke @s only arc_item_base:platinum/platinum_hoe
...
advancement revoke @s only arc_item_base:platinum/platinum_shovel
...
recipe take @s arc_item_base:diamond/diamond_katana
...
advancement revoke @s only arc_item_base:diamond/diamond_katana
#woods
recipe take @s arc_item_base:wood/wooden_boots
recipe take @s arc_item_base:wood/wooden_chestplate
recipe take @s arc_item_base:wood/wooden_greatsword
recipe take @s arc_item_base:wood/wooden_helmet
recipe take @s arc_item_base:wood/wooden_leggings
advancement revoke @s only arc_item_base:wood/wooden_boots
advancement revoke @s only arc_item_base:wood/wooden_chestplate
