#platinum
recipe take @s arc_item_base:platinum/platinum_sword
advancement revoke @s only arc_item_base:platinum/platinum_sword
#diamonds
recipe take @s arc_item_base:diamond/diamond_sword
advancement revoke @s only arc_item_base:diamond/diamond_sword
#woods
recipe take @s arc_item_base:wood/wooden_sword
advancement revoke @s only arc_item_base:wood/wooden_sword
#offhand
...
recipe take @s arc_item_base:platinum/platinum_greatsword
advancement revoke @s only arc_item_base:platinum/platinum_greatsword
recipe take @s arc_item_base:diamond/diamond_greatsword
advancement revoke @s only arc_item_base:diamond/diamond_greatsword
recipe take @s arc_item_base:darkknight/darkknight_sword
# advancement revoke @s only arc_item_base:darkknight/darkknight_sword
recipe take @s arc_item_base:cryob/cryob_greatsword
advancement revoke @s only arc_item_base:cryob/cryob_greatsword

recipe take @s arc_item_base:wood/wooden_axe
advancement revoke @s only arc_item_base:wood/wooden_axe
recipe take @s arc_item_base:stone/stone_axe
advancement revoke @s only arc_item_base:stone/stone_axe
recipe take @s arc_item_base:iron/iron_axe
advancement revoke @s only arc_item_base:iron/iron_axe
recipe take @s arc_item_base:gold/golden_axe
advancement revoke @s only arc_item_base:gold/golden_axe
recipe take @s arc_item_base:platinum/platinum_axe
advancement revoke @s only arc_item_base:platinum/platinum_axe
recipe take @s arc_item_base:diamond/diamond_axe
advancement revoke @s only arc_item_base:diamond/diamond_axe
...
recipe take @s arc_item_base:ice/ice_scythe
