...
data modify entity @s Item.tag.display.Lore[0] set value '{"text":"✦✦✦✦ Epic ▬▬▬","color":"dark_purple","bold":false,"italic":false}'
data modify entity @s Item.tag.class set value 4b
