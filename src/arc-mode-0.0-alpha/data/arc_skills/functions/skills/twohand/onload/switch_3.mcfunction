data modify storage twohand modified insert 0 from entity @s Inventory[{Slot:3b}]
data modify storage twohand modified[{Slot:3b}].Slot set value 0b
...
loot replace entity @s hotbar.3 1 mine 0 0 16
