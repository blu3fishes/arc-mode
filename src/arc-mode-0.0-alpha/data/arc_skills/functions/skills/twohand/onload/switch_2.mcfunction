data modify storage twohand modified insert 0 from entity @s Inventory[{Slot:2b}]
data modify storage twohand modified[{Slot:2b}].Slot set value 0b
...
loot replace entity @s hotbar.2 1 mine 0 0 16
