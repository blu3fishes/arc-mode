...
data modify entity @s Item.tag.display.Lore[0] set value '{"text":"✦✦✦✦✦ Legendary ▬▬▬","color":"yellow","bold":false,"italic":false}'
data modify entity @s Item.tag.class set value 5b
